                        ...
                        <div className="regpage-content">
                            <div className="regpage-table">
                                <div className="regpage-table-header">
                                    <div className="regpage-table-header-content">TRANG CHÍNH</div>
                                </div>
                                    ...
                                    <table className="table table-striped table-hover">
                                        <tbody>
                                            ...
                                            <tr style={{ cursor: 'pointer' }}>
                                                ...
                                                <td>Kiểm tra kết quả đăng ký và hiệu chỉnh đăng ký môn học HK2/2023-2024 (Đợt 2)- <strong style={{ color: 'red' }}>Kết quả</strong> đợt 1
                                                </td>
                                            </tr>
                                            <tr style={{ cursor: 'pointer' }}>
                                                <td>3</td>
                                                ...
                                                <td>Đăng ký các học phần có nhu cầu học HK2/2023-2024 tất cả các diện sinh viên</td>
                                            </tr>
                                            <tr style={{ cursor: 'pointer' }}>
                                                <td>4</td>
                                                <td>2023-2024</td>
                                                <td style={{ color: 'blue' }}>HK_HK231_3</td>
                                                <td>Kiểm tra <strong style={{ color: 'red' }}>Kết quả</strong> đăng ký và đăng ký bổ sung môn học HK1/2023-2024 (Đợt 3)- <strong style={{ color: 'red' }}>Kết quả</strong> đợt 2
                                                </td>
                                            </tr>
                                            <tr style={{ cursor: 'pointer' }}>
                                                <td>5</td>
                                                ...
                                                <td>Kiểm tra kết quả đăng ký và hiệu chỉnh đăng ký môn học HK1/2023-2024 (Đợt 2)- <strong style={{ color: 'red' }}>Kết quả</strong> đợt 1
                                                </td>
                                            </tr>
                                            <tr style={{ cursor: 'pointer' }}>
                                                <td>6</td>
                                                ...
                                                <td>Đăng ký các học phần có nhu cầu học HK1/2023-2024 tất cả các diện sinh viên</td>
                                            </tr>
                                            ...
                                            <tr style={{ cursor: 'pointer' }}>
                                                ...
                                                <td>Kiểm tra <strong style={{ color: 'red' }}>Kết quả</strong> đăng ký và đăng ký bổ sung môn học HK2/2022-2023 (Đợt 3)- <strong style={{ color: 'red' }}>Kết quả</strong> đợt 2
                                                </td>
                                            </tr>
                                            <tr style={{ cursor: 'pointer' }}>
                                                <td>8</td>
                                                ...
                                                <td>Kiểm tra kết quả đăng ký và hiệu chỉnh đăng ký môn học HK2/2022-2023 (Đợt 2)- <strong style={{ color: 'red' }}>Kết quả</strong> đợt 1
                                                </td>
                                            </tr>
                                            <tr style={{ cursor: 'pointer' }}>
                                                <td>9</td>
                                                ...
                                                <td>Đăng ký các học phần có nhu cầu học HK2/2022-2023 tất cả các diện sinh viên</td>
                                            </tr>
                                            <tr style={{ cursor: 'pointer' }}>
                                                <td>10</td>
                                                <td>2022-2023</td>
                                                <td style={{ color: 'blue' }}>HK_HK221_3</td>
                                                <td>Kiểm tra <strong style={{ color: 'red' }}>Kết quả</strong> đăng ký và đăng ký bổ sung môn học HK1/2022-2023 (Đợt 3)- <strong style={{ color: 'red' }}>Kết quả</strong> đợt 2
                                                </td>
                                            </tr>
                                            <tr style={{ cursor: 'pointer' }}>
                                                <td>11</td>
                                                ...
                                                <td>Kiểm tra kết quả đăng ký và hiệu chỉnh đăng ký môn học HK1/2022-2023 (Đợt 2)- <strong style={{ color: 'red' }}>Kết quả</strong> đợt 1
                                                </td>
                                            </tr>
                                            <tr style={{ cursor: 'pointer' }}>
                                                <td>12</td>
